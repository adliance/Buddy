...
/// <summary>
/// The contract for an email renderer without blocking.
/// </summary>
public interface IEmailRendererNonBlocking
{
    /// <summary>
    ...
    Task RenderAndSendNonBlocking(string recipientAddress, string templateBaseName, object viewModel,
    ...
    /// <param name="viewModel">The view model data for the razor template.</param>
    /// <param name="attachments">A collection of file attachments that will be included in the message.</param>
    Task RenderAndSendNonBlocking(IEmailRecipient[] to, IEmailRecipient[] cc, IEmailRecipient[] bcc, string templateBaseName,
    ...
    /// <param name="viewModel">The view model data for the razor template.</param>
    /// <param name="attachments">A collection of file attachments that will be included in the message.</param>
    Task RenderAndSendNonBlocking(IEmailRecipient[] to, string templateBaseName, object viewModel, params IEmailAttachment[] attachments);
    ...
    /// <param name="viewModel">The view model data for the razor template.</param>
    /// <param name="attachments">A collection of file attachments that will be included in the message.</param>
    Task RenderAndSendNonBlocking(string recipientAddress, string templateDirectoryName, string subjectTemplateName,
    ...
    /// <param name="viewModel">The view model data for the razor template.</param>
    /// <param name="attachments">A collection of file attachments that will be included in the message.</param>
    Task RenderAndSendNonBlocking(IEmailRecipient[] to, IEmailRecipient[] cc, IEmailRecipient[] bcc, string templateDirectoryName, string subjectTemplateName,
        string htmlTemplateName, string textTemplateName, object viewModel, params IEmailAttachment[] attachments);
    ...
    /// <param name="viewModel">The view model data for the razor template.</param>
    /// <param name="attachments">A collection of file attachments that will be included in the message.</param>
    Task RenderAndSendNonBlocking(IEmailRecipient[] to, string templateDirectoryName, string subjectTemplateName,
        string htmlTemplateName, string textTemplateName, object viewModel, params IEmailAttachment[] attachments);
}
