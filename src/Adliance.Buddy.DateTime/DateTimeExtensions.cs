...
public static class DateTimeExtensions
{
    ...
    public static DateTime? UtcToCet(this DateTime? utcDateTime)
    {
    ...
    public static DateTime? CetToUtc(this DateTime? cetDateTime)
    {
    ...
    public static string FormatDate(this DateTime? dateTime, string format = DefaultDateFormat, string culture = DefaultCulture)
    {
        return dateTime.HasValue ? FormatDate(dateTime.Value, format, new CultureInfo(culture)) : "";
    }

    public static string FormatUtcAsCetDate(this DateTime? dateTime, string format = DefaultDateFormat, string culture = DefaultCulture)
    {
    ...
    public static string FormatDate(this DateTime dateTime, string format, CultureInfo culture)
    {
        return dateTime == default ? "" : dateTime.ToString(format, culture);
    }

    public static string FormatUtcAsCetDate(this DateTime dateTime, string format, CultureInfo culture)
    {
    ...
    public static string FormatDateTime(this DateTime? dateTime, string format = DefaultDateTimeFormat, string culture = DefaultCulture)
    {
        return dateTime.HasValue ? FormatDateTime(dateTime.Value, format, new CultureInfo(culture)) : "";
    }

    public static string FormatUtcAsCetDateTime(this DateTime? dateTime, string format = DefaultDateTimeFormat, string culture = DefaultCulture)
    {
    ...
    public static string FormatDateTime(this DateTime dateTime, string format, CultureInfo culture)
    {
        return dateTime == default ? "" : dateTime.ToString(format, culture);
    }

    public static string FormatUtcAsCetDateTime(this DateTime dateTime, string format, CultureInfo culture)
    {
