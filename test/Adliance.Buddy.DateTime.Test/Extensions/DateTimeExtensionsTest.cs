...
namespace Adliance.AspNetCore.Buddy.Test.Extensions;
...
public class DateTimeExtensionsTest
{
    ...
    {
        Assert.Equal(DateTime.Parse(expectedDate), DateTime.Parse(originalDate).UtcToCet());
    }

    [Fact]
    public void Can_Support_Null_When_Converting_Utc_To_Cet()
    {
        Assert.Null((null as DateTime?).UtcToCet());
    }
    ...
    {
        Assert.Equal(DateTime.Parse(expectedDate), DateTime.Parse(originalDate).CetToUtc());
    }

    [Fact]
    public void Can_Support_Null_When_Converting_Cet_To_Utc()
    {
        Assert.Null((null as DateTime?).CetToUtc());
    }
    ...
    {
        Assert.Equal(expectedResult, DateTime.Parse(date).FormatDate());
    }
    
    [Fact]
    public void Can_Support_Null_When_Formatting_Date()
    {
        Assert.Equal("", (null as DateTime?).FormatDate());
    }
    ...
    {
        Assert.Equal(expectedResult, DateTime.Parse(date).FormatUtcAsCetDate());
    }
    
    [Fact]
    public void Can_Support_Null_When_Formatting_Utc_Date()
    {
        Assert.Equal("", (null as DateTime?).FormatUtcAsCetDate());
    }
    ...
    {
        Assert.Equal(expectedResult, DateTime.Parse(date).FormatDateTime());
    }
    
    [Fact]
    public void Can_Support_Null_When_Formatting_DateTime()
    {
        Assert.Equal("", (null as DateTime?).FormatDateTime());
    }
    ...
    {
        Assert.Equal(expectedResult, DateTime.Parse(date).FormatUtcAsCetDateTime());
    }
    
    [Fact]
    public void Can_Support_Null_When_Formatting_Utc_DateTime()
    {
        Assert.Equal("", (null as DateTime?).FormatUtcAsCetDateTime());
    }
}