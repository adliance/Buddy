...
public class DateTimeExtensionsTest
{
    ...
    {
        Assert.Equal(System.DateTime.Parse(expectedDate, CultureInfo.InvariantCulture), System.DateTime.Parse(originalDate, CultureInfo.InvariantCulture).UtcToCet());
    }
    ...
    {
        Assert.Equal(System.DateTime.Parse(expectedDate, CultureInfo.InvariantCulture), System.DateTime.Parse(originalDate, CultureInfo.InvariantCulture).CetToUtc());
    }
    ...
    {
        Assert.Equal(expectedResult, System.DateTime.Parse(date, CultureInfo.InvariantCulture).FormatDate());
    }
    ...
    {
        Assert.Equal(expectedResult, System.DateTime.Parse(date, CultureInfo.InvariantCulture).FormatUtcAsCetDate());
    }
    ...
    {
        Assert.Equal(expectedResult, System.DateTime.Parse(date, CultureInfo.InvariantCulture).FormatDateTime());
    }
    ...
    {
        Assert.Equal(expectedResult, System.DateTime.Parse(date, CultureInfo.InvariantCulture).FormatUtcAsCetDateTime());
    }
